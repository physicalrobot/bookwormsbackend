...
SECRET_KEY = 'django-insecure-2o@htbwwvw50j3s@#jxsye3ml8j)49)73+pg=_@3)@majz+a9g'
...
INSTALLED_APPS = [
    ...
    'BookShelvesApp.apps.BookshelvesappConfig',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'bookwormsfrontend/build'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# STATICFILES_DIRS =  [
#         os.path.join(BASE_DIR, 'bookwormsfrontend/build/static'),
# ]
